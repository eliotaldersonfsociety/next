      ...
      {loading ? (
        ...
        <div className="relative">
          ...
          >
            ...
            <Card className="min-w-[200px] max-w-[200px] h-[500px] flex flex-col justify-center items-center snap-start bg-gradient-to-br from-primary/80 to-primary shadow-lg border-0">
