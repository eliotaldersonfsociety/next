    ...
    const fetchProducts = async () => {
      try {
        ...
        const res = await fetch(
          `https://texasstore-108ac1a.ingress-haven.ewp.live/wp-json/wc/v3/products?category=221&per_page=20`,
          {
    ...
    <>
      ...
      <div className="bg-white lg:mx-36">
        <main className="text-center px-5 mt-20 pb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-8 capitalize">Salud</h1>
